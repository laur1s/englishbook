...
steps:
  ...
  - kind: "prep"
    ...
    support:
      ...
      - "work or study"
  - kind: "speak"
    prompt: "Speak for one minute. Use present perfect first, then add one past detail."
    ltPrompt: "Kalbėkite vieną minutę. Pirma naudokite present perfect, tada pridėkite vieną praeities detalę."
    seconds: 60
    support:
      - "I've visited..."
      - "I've never tried..."
