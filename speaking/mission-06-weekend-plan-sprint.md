...
steps:
  - kind: "brief"
    ...
    ltPrompt: "Papasakokite draugui apie savo savaitgalio planą ir skambėkite nuoširdžiai susidomėję."
    support:
      - "Use at least two future forms."
      - "Mention when and with whom."
      - "Add one optional plan if the weather changes."
  - kind: "prep"
    prompt: "Choose Saturday, Sunday, and one backup plan."
    ltPrompt: "Pasirinkite šeštadienio planą, sekmadienio planą ir vieną atsarginį variantą."
    seconds: 20
    support:
      - "Saturday"
      - "Sunday"
